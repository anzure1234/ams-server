...
public class LoginResource extends BaseResource {
    ...
    public ResponseEntity<BaseResponseDto> refreshToken(@Valid @RequestBody TokenRefreshRequestDto request)   {
...
//                throw new NullPointerException("login.resource.refreshtoken.expired");
//            }
            ...
            return forbidden("login.resource.refreshtoken.expired");
        }
